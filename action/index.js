...
function blobUpload() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const { connectionString, containerName, sourceDir, overwrite } = getInputData();
            const filesToUpload = yield getFilesToUpload(sourceDir);
            core.notice(`Upload the following files:\n${filesToUpload.join('\n')}`);
            console.log(connectionString, containerName, sourceDir, overwrite);
 ...
 */
function getFilesToUpload(sourceDir) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, globby_1.globby)([sourceDir]);
    });
}
/**
...
function getInputData() {
    ...
    return { connectionString, containerName, sourceDir, overwrite };
}
/**
...
function printHelp() {
  ...
  The Following Parameter are supported:
    connectionString - (mandatory) The Azure connection string for the blob Storage
    containerName -    (mandatory) The Azure container name
    sourceDir -        (mandatory) The Source directory which contains the files to be uploaded.
    ...
    overwrite -        (optional) default is false. When set to true, existing files are overwritten
`);
}
// import fs from 'fs'
...
//   fileList: string[]
//   /**
//    * The base directory wich is substracted from teh file names later on.
//    * So in the blob storge the relative path to fbaseDir is used
//    */
//   baseDir:string
// }
// /**
//  * Downloads a blob from the blob storage and returns it
//  * @param containerName - The name of the container in the Azure blob storage
//  * @param blobName - The name of the file in the container
//  * @param content - The content to be stored
//  * @param connectionString - The Azure connectionString
//  * @returns blob - The donwloaded file
//  */
// export async function blobUpload(params: interfaceUploadConfig) {
//   const { connectionString, containerName, fileList, baseDir } = params
//   try {
//     const blobServiceClient =
//       BlobServiceClient.fromConnectionString(connectionString)
//     const containerClient = blobServiceClient.getContainerClient(containerName)
//     for(const file of fileList){
//       const relativeFileName = path.relative(baseDir, file)
//       const fileContent = await readFile(file,'utf8')
//       const blobClient = containerClient.getBlockBlobClient(relativeFileName)
//       await blobClient.upload(fileContent, fileContent.length)
//     }
//    } catch (error) {
//     throw new Error(
//       `The blob '${containerName}/${blobName}' could not be uploaded:\nerror.message`
//     )
//   }
// }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const blobUpload_1 = __nccwpck_require__(3534);
(0, blobUpload_1.blobUpload)()
    .then(() => {
